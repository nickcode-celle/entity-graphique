...
import './style.css'
import {createNewMarbleBirth} from './new-marble-birth.js'
...
const bloomLayer=1
const newMarbleBirth=createNewMarbleBirth(THREE,scene,bloomLayer)
