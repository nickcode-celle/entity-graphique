...
const TEST_COUNTS=[300,500,750,1000,1500,2000];const requestedCount=Number(new URLSearchParams(location.search).get('balls'));const BODY_COUNT=TEST_COUNTS.includes(requestedCount)?requestedCount:750,SATELLITE_COUNT=5,LEVEL=.50,CAPACITES=.50
