...
// DONUT TEST : valeurs historiques dédiées au DONUT.
...
const status=document.createElement('div');status.textContent='DONUT TEST — séparation 30 · alignement 8 · cohésion 60';Object.assign(status.style,{position:'fixed',left:'14px',bottom:'12px',color:'rgba(255,255,255,.62)',font:'12px Arial',pointerEvents:'none'});document.body.appendChild(status)
